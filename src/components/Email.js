    ...
    return (
      ...
      <div className="col-12">
        ...
        <div className="form-input" style={{ display: inputFormDisplay }}>
          <h1 style={{ textAlign: "center" }}>Enter your information to get coupons and here about events</h1>
          <form
            className="form-inside-input"
            onSubmit={this.onSubmit}
            noValidate
          >
            <input type="email" name="email" placeholder="Email" required  className="emailInput" />
            <br />
